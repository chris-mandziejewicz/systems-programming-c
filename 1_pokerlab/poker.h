...
int fourofaking_check (hand_t, hand_t);//Added function
int threeofakind_check (hand_t, hand_t);//Added function
int twopairs_check (hand_t, hand_t);//Added function
int onepair_check (hand_t, hand_t);//Added function
